...
func RegisterService(r Registration) error {
	...
	if res.StatusCode != http.StatusOK {
		return fmt.Errorf("Faild to register service. Registry service responded with code %v", res.StatusCode)
	}
...
func ShutDownService(serviceURL string) error {
	...
	if res.StatusCode != http.StatusOK {
		return fmt.Errorf("Failed to deregister the service. Responded with code: %v", res.StatusCode)
	}
